...
const ManageAllOrders = () => {
    ...
    const { data: orders, isLoading, refetch } = useQuery('orders', () => fetch('https://auto-parts-backend.vercel.app/orders/').then(res => res.json()));
    ...
    // useEffect(() => {
    //     fetch('https://auto-parts-backend.vercel.app/orders')
    //         .then(res => res.json())
