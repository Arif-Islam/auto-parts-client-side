        ...
        <div className='shadow-lg rounded p-6 bg-white hover:shadow-xl'>
            <div className=' md:w-[500px]'>
                <div className='flex space-x-4 items-center mb-4'>
                    <img className='w-24 h-24 hover:scale-90 transition ease-in-out object-cover rounded-full border-cyan-500 border-2' src={image} alt="" />
                    <div className='flex flex-col'>
                        <p className='text-lg text-[#0eadc9] font-semibold'>{name}</p>
